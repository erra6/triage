...
// … resto
	...
	$db=mysql_select_db("triage",$resultado);		
      ...
      $query = "SELECT pacientes.sexo,sintomatologia.IDsintoma,sintomatologia.sintoma,anatomia.anatomia,causa.causa,tramosedad.tramoEdad,ambulancias.IndicativoSOS,
                ...
                WHERE (incidencias.IDTracking < 7 OR incidencias.IDTracking = 8) AND incidencias.IDIncidencia=$idincidencia;";
