...
// Recibiendo las  variables  FLASH
	...
	$idambulancia=$_POST['idambulancia'];  //  si deseas  hacer algun UPDATE
// conexiones  MySQL
// base de  datos seleccion
    ...
    if($idambulancia==-1){
        $query1 = "UPDATE incidencias SET IDAmbulancia=NULL,IDTracking=1 WHERE IDIncidencia=$idincidencia;";
    }else{    
        $query1 = "UPDATE incidencias SET IDAmbulancia=$idambulancia,IDTracking=2 WHERE IDIncidencia=$idincidencia;";
    }
	//$query1 = "UPDATE incidencias SET IDAmbulancia=$idambulancia WHERE IDIncidencia=$idincidencia;";	
