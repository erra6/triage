...
// Si es "ver" lo mandamos a su vista
if ($grupo === 'ver') {
    header("Location: ver.php");
    exit();
}

// Solo "admin" puede acceder a hospital.php
if ($grupo !== 'admin') {
    header("Location: index.php");
    exit();
}
...
<head>
    ...
    <title>Pompièrs - Control Hospitalario</title>

    <!-- JS -->
    <script src="js/prototype.js"></script>
    <script src="js/effects.js"></script>
    <script src="js/dump.js"></script>
    <script src="js/incidencias.hospital.js"></script>
...
<body>
    ...
    <div class="left menu">
        <ul id="menu">
            ...
            <li id="menu_mapa"><a href="hospital.php" class="current" title="Hospital">Control sanitario</a></li>
    ...
    <div class="row_header">
        ...
        <div class="left left5" style="margin-top:3px;">
            <b><div id="colorheader"></div></b>
        </div>
        <div class="row_header_hospi left" style="margin-top:3px;">
            <b><div id="hospiheader"></div></b>
        </div>
        <div class="clearingBR"></div>
